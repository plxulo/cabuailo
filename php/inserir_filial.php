<?php
  ...
  $inserir_filial = $pdo->prepare("INSERT INTO filiais (nome, endereco, cep, filial_adm, imagem, descricao, servicos, delivery) VALUES (?, ?, ?, ?, ?, ?, ?, ?)");
  ...
  $inserir_filial->bindParam(8, $delivery);
